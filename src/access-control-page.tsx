      ...
      <section className="access-system" id="access-system">
        ...
        <div className="access-system-copy">
          ...
          <p>
            ...
            ต้องออกแบบให้ชุดควบคุม กลอนไฟฟ้า เซนเซอร์ประตู ปุ่มกดออก
            และระบบไฟสำรองทำงานร่วมกันอย่างเหมาะสม
          </p>
          <ul>
            <li><span>✓</span> กำหนดสิทธิ์รายบุคคลหรือรายแผนก</li>
            <li><span>✓</span> ตั้งช่วงเวลาที่อนุญาตให้เข้า–ออก</li>
            <li><span>✓</span> เพิ่ม ลบ หรือระงับผู้ใช้งานได้</li>
            <li><span>✓</span> รองรับประตูสำนักงาน อาคาร และโรงงาน</li>
          </ul>
        </div>
      </section>
