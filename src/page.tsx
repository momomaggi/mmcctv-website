  ...
  return (
    <main>
      ...
      <section className="contact" id="contact">
        ...
        <div className="contact-card"><small>LINE OFFICIAL / LINE ID</small><strong>mmcctv2</strong><a className="btn white" href="https://line.me/ti/p/~mmcctv">ทัก LINE ตอนนี้ <span>↗</span></a><p>เวลาทำการ จันทร์–ศุกร์ 08.30–16.30 น.</p></div>
      </section>
