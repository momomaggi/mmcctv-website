        ...
        <div className="work-grid">
          <div className="work-main">
            <img
              ...
              loading="lazy"
              /><span></span>บ้านพักอาศัยและร้านค้า</span><h3>ติดตั้งกล้อง IP พร้อมเดินท่อเก็บสาย</h3></div><div className="work-side"><div><span>โรงงานและโกดัง</span><h3>ระบบกล้องพร้อมตู้ควบคุม</h3></div><div><span>สำนักงาน</span><h3>ระบบสแกนใบหน้าเข้า–ออก</h3></div></div></div>
      </section>
